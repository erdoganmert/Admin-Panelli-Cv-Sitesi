                ...
                <div class="row">
                    ...
                    <div class="card card-info col-md-12">
                        <div class="card-header">
                            <h3 class="card-title">İş Düzenle</h3>
                        </div>
                        ...
                        $query->execute([$is_id]);
                        $is = $query->fetch(PDO::FETCH_ASSOC);
                        ?>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="is-islem.php?is_id=<?= $is_id ?>" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10" style="margin-top: 8px;" >
                                        <label class="radio-inline">
                                            <input type="radio" name="is_devam" value="1" <?= $is['is_devam'] == 1 ? "checked" : null; ?>> Evet
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="is_devam"  value="2" style="margin-left: 10px;" <?= $is['is_devam'] == 2 ? "checked" : null; ?>> Hayır
                                        </label>
                                ...
                                <div class="card-footer">
                                    <input type="hidden" name="is_duzenle" value="1">
