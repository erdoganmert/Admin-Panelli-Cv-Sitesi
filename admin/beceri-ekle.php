                ...
                <div class="row" style="width: auto;">
                    ...
                    <div class="card card-info col-md-12">
                        <div class="card-header">
                            <h3 class="card-title">Beceri Ekle</h3>
                        </div>
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="beceri-islem.php" method="POST" class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="label" class="col-sm-2 col-form-label">Beceri Adı</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="beceri_adi"
                                               placeholder="Becerinizin Adını Giriniz.."
                                               value="<?= $_GET["beceri_adi"] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="beceri_yuzde"
                                               placeholder="Beceri Yüzdenizi Girin.."
                                               value="<?= $_GET["beceri_yuzde"] ?>">
                                    </div>
                                </div>

                                <div class="card-footer">
                                    <input type="hidden" name="beceri_ekle" value="1">
